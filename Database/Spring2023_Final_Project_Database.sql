...
INSERT INTO Products(name, quantity, price, image, description, status, is_delete, create_date, update_date, prod_material_id, categories_id, discount_id) VALUES
	...
	('Cây Đa Cảnh Bonsai', 20, 250, 'cay-da-canh.png', 'Cây đa bonsai quen thuộc với bộ rễ vô cùng hùng vĩ và được uốn nắn rất nghệ thuật tùy theo tay nghề nghệ nhân. Lá cây rất nhỏ hơn lá cây đa cổ thụ nhiều. Cây có sức chịu đựng dẻo dai và nhạy cảm với sự thay đổi của nhiệt độ môi trường.', 1, 0, '2020-1-11', '2020-1-11', null, 1, null),
	...
	('Cây Mai Vàng', 30, 1000, 'cay-mai.png', 'Hoa Mai Vàng có 5 cánh, màu rực rỡ, trưng trong nhà dễ sống mà lại mang không khí rộn ràng cứ như không khí Tết sắp tràn về. Khi làm dáng Bonsai, nghệ nhân thường để cho bộ rễ của Mai vàng trồi lên to trông quyền lực hơn và tăng thêm giá trị tinh thần của ngôi nhà.', 1, 0, '2020-1-11', '2020-1-11', null, 1, 1),
	...
	('Cây Hải Chau', 50, 1000, 'cay-hai-chau.png', 'Tuy có tốc độ lớn chậm và lá nhỏ nhưng cây lại mang dáng dấp khá đẹp. Hải châu mang đủ các yếu tố của một cây bonsai đẹp, thân rễ đều chắc chắn, dễ uốn các dáng hình, đáng để các bạn trưng tại vườn nhà, ban công…', 1, 0, '2020-1-11', '2020-1-11', null, 1, 1),
	('Cây Tùng Bồng Lai', 60, 1600, 'cay-tung-bong-lai.png', 'Tùng Bồng Lai có bộ rễ khỏe khoắn vì trong tự nhiên cây này mọc ở những vách đá cheo leo. Cây Tùng Bồng Lai chịu được sức gió và khí hậu không kén chọn nên có sức sống mãnh liệt, biểu tượng của trường thọ, sống lâu.', 1, 0, '2020-1-11', '2020-1-11', null, 1, 1),
	...
	('Cây Nguyệt Quế', 65, 200, 'cay-nguyet-que.png', 'Cây nguyệt quế có tên gọi rất đẹp và ý nghĩa của vinh quang. Nhắc tới nguyệt quế được đội lên đầu người chiến thắng gọi là vòng nguyệt quế. Cây mọc hoang trong rừng ở nước ta và còn được dùng như một vị thuốc.', 1, 0, '2020-1-11', '2020-1-11', null, 1, null),
	...
	('Cây Phú Quý', 30, 100, 'cay-phu-quy.png', 'Màu đỏ là màu của may mắn, do đó cây Phú Quý trong phong thủy là cây biểu tượng cho những điều tốt lành. Đồng thời, giống như tên gọi mà người ta đặt cho cây, Phú Quý mang đến sự giàu sang, tài lộc, phú quý cho người trồng.', 1, 0, '2020-1-11', '2020-1-11', null, 2, 2),
    ...
    -- HOA CHẬU
    ('Hoa Cúc Indo', 25, 150, 'hoa-cuc-indo.png', 'Tên khoa học của chậu cây cúc indo là “Rondeletia leucophylla” thuộc họ Cà phê – Rubiaceae, bắt nguồn từ Mexico. Là một loại cúc lá to, có lông trắng dày và một lá nhỏ, lá nhỏ thì thường nở nhiều vào tháng 4 đến tháng 10.', 1, 0, '2020-1-11', '2020-1-11', null, 3, 1),    
	...
	('Hoa Cẩm Chướng', 30, 100, 'hoa-cam-chuong.png', 'Hoa được nhiều người biết đến là loài hoa sở hữu nhiều màu sắc như trắng, xanh, vàng, hồng, đỏ và chúng có thân hình mảnh mai, lá thuôn dài và có chiều dài từ 10 - 15cm.', 0, 0, '2020-1-11', '2020-1-11', null, 3, 1),
	...
	('Hoa Păng-xe', 25, 80, 'hoa-pang-xe.png', 'Hoa Păng-xê có tên gọi khác là hoa cánh bướm. Loài hoa này được nhiều người yêu thích bởi vẻ ngoài mềm mại, thanh thoát và mĩ miều khiến gia chủ cảm thấy vui vui tươi, thư giãn.', 1, 0, '2020-1-11', '2020-1-11', null, 3, 1),
	...
	('Hoa Thu Hải Đường', 30, 100, 'hoa-thu-hai-duong.png', 'Nhỏ nhắn mà rực rỡ, thu hải đường là loài hoa được rất nhiều người lựa chọn để trồng trong chậu nhỏ dưới đất hay treo lên cao. Loài hoa này có thể chịu được độ nóng, nên trồng trong bóng râm.', 0, 0, '2020-1-11', '2020-1-11', null, 3, null),
	
    ('Hoa Đồng Tiền', 45, 50, 'hoa-dong-tien.png', 'Hoa đồng tiền được xem là tượng trưng cho sự sung túc, tình yêu và hạnh phúc viên mãn.  Cây hoa đồng tiền khá dễ trồng và chăm sóc nên bạn có thể lựa chọn để tô điểm cho ngôi nhà của mình.', 1, 0, '2020-1-11', '2020-1-11', null, 3, null),
	('Hoa Thủy Tiên', 30, 150, 'hoa-thuy-tien.png', 'Thủy tiên - loài hoa với cái tên tên kiêu sa - được chọn là loài hoa tiêu biểu cho tháng 3, tháng của tiết xuân phân. Màu trắng thanh khiết hay màu vàng sang trọng được xem là biểu tượng cho mùa xuân, mùa của sự hồi sinh, đâm chồi nảy lộc.', 1, 0, '2020-1-11', '2020-1-11', null, 3, 2),
	('Hoa Ly', 20, 150, 'hoa-ly.png', 'Hoa Ly là biểu tượng của sự thanh lịch, sang trọng và nhã nhặn. Hoa ly thanh khiết và hoa ly cũng rất đẹp nên mỗi một màu ly mang một ý nghĩa khác nhau.', 1, 0, '2020-1-11', '2020-1-11', null, 3, null),
	('Hoa Hồng', 30, 200, 'hoa-hong.png', 'Hoa hồng được biết là loài hoa dạng bụi, có nhiều cành và gai cong. Lá hoa hồng là loại lá kép lông chim mọc cách. Còn hoa hồng là loài hoa lưỡng tính, có hương thơm nhẹ, cánh hoa mỏng nhẹ. Hoa hồng nở quanh năm và lâu tàn.', 1, 0, '2020-1-11', '2020-1-11', null, 3, null),
	('Hoa Dừa Cạn', 40, 80, 'hoa-dua-can.png', 'Hoa dừa cạn là món quà đầy ý nghĩa trong dịp mừng sinh nhật mừng thọ, hay dịp lễ tết với ý nghĩa trường xuân. Dừa cạn cũng có ý nghĩa chúc thành công trong sự nghiệp và học vấn nếu bạn đang là một sỹ tử.', 1, 0, '2020-1-11', '2020-1-11', null, 3, null),
    ...
    ('NPK Phục Hồi Cây Trồng', 20, 165, 'npk_halan.png', 'Phân bón NPK phục hồi cây trồng, công thức dạng chữ L có hàm lượng đạm (N) cao, lân (P2O5) thấp và kali (K2O) thấp phù hợp cho việc phục hồi cây trồng sau thu hoạch, giúp cây phát triển mạnh cành lá.', 0, 0, '2020-1-11', '2020-1-11', null, 5, null);
